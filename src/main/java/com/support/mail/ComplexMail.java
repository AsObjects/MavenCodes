...
public class ComplexMail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //3、连上邮件服务器
        ts.connect("smtp.163.com", "angel809294@163.com", "lajidhao809294");
        //4、创建邮件
    ...
    */ 
    public static MimeMessage createMixedMail(Session session) throws Exception {
        ...
        //设置邮件的基本信息
        message.setFrom(new InternetAddress("angel809294@163.com"));
        message.setRecipient(Message.RecipientType.TO, new InternetAddress("708884645@qq.com"));
        ...
        image.setDataHandler(new DataHandler(new FileDataSource("src\\3.png")));
