...
public class ConstellationUtil {
	//星座枚举
		...
		public static Constellation calculateConstellation(Date birthday) {
			//TODO:这里有点问题，研究下这个包
			//String sBirthday = DateUtil.formatDate(birthday,"yyyy-MM-dd");
			return calculateConstellation(birthday);
		}
		 ...
		 * @return
		 */
		public static Constellation calculateConstellation(String birthday) {
